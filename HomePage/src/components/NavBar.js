        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#projects" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>Aprende con nosotros</Nav.Link>
            </Nav>
            <span className="navbar-text">
              ...
              <HashLink to='#connect'>
                <button className="vvd"><span>Ingresar</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
